...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EmotiCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed1.emoticoiners.net", "seed1.emoticoiners.net"},
    {"seed0.emoticoiners.net", "seed0.emoticoiners.net"},
    {"seed1.emoticoin.org", "seed1.emoticoin.org"},
    {"seed0.emoticoin.org", "seed0.emoticoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"emoticoin.org", "seed0.emoticoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EmotiCoin is probably already running."), addrBind.ToString().c_str());
        else
